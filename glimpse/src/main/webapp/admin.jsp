...
<html>
  <head>
    ...
    <!-- Any title is fine                         -->
    <!--                                           -->
    <title>Glimpse News Aggregator - Administration</title>
    ...
    <!--                                           -->
    <script type="text/javascript" language="javascript" src="glimpse_gwt_admin/glimpse_gwt_admin.nocache.js"></script>
  </head>
